  ...
  const fetchProductData = async() => {
    try{
      ...
      const handleSuggestionClick = (suggestion) => {
        setQuery(suggestion.productName); // or use suggestion.productCode
        setShowSuggestions(false);
        setIsSelected(true)
        setSelectedProduct(suggestion)
      };

      const boxes = Array.from({ length: rows * columns }, (_, index) => index + 1);
  return (
    <React.Fragment>
      ...
      <Content >
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              {/* <BlockTitle tag="h5">Search</BlockTitle> */}
          ...
          <Row className="g-gs">
            <Col lg="7">
              <PreviewCard className="h-100">
                <div className="card-head">
                  <h5 style={{textDecoration:"underline"}} className="card-title">Search Product</h5>
                </div>
               <div className="search-bar mt-5">
                ...
                <div style={{marginTop:"30%", height:"150px"}}>
                <RoleList isSelected={isSelected} selectedProduct={selectedProduct}/>
                </div>
                {/* <form>
            ...
            <Col lg="5">
              <PreviewCard className="h-100">
                <div className="card-head">
                  <h5 style={{textDecoration:"underline"}} className="card-title">Rack Label</h5>
                </div>
                  
                <div className="row">

                <div className="col-md-6 mt-3 text-center">
                    <h4 className="card-title">Row</h4>
                    <h3 style={{ color: "#798BFF", marginTop: "10px" }}>{isSelected? selectedProduct.row : "-"}</h3>
                  </div>

                  <div className="col-md-6 mt-3 text-center">
                    <h4 className="card-title">Column</h4>
                    <h3 style={{ color: "#798BFF", marginTop: "10px" }}>{isSelected? selectedProduct.coloumn : "-"}</h3>
                  </div>
                </div>
               {isSelected && (
                ...
                <div className="grid-container mt-5">
                  {boxes.map((box, index) => (
                    <div
                      ...
                      style={{
                        backgroundColor:
                          isSelected && box === selectedProduct.coloumn ? 'red' : '#ddd',
                      }}
                    >
                      {box}
                    </div>
