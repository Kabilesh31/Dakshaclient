...
// import logoimg from '../../../images/resized_45906_universityLogo.jpg'
import {
  DropdownMenu,
  DropdownToggle,
  FormGroup,
...
const HeaderSettings = () => {
  ...
  const categorySelect = categoryData.map((item) => (
    { key:item.ov_category_type_id, value: item.category_type, label: item.category_type }
  ))
  ...
  const handleExport = () => {
    ...
    html2canvas(input, {
      ...
      useCORS: true, // Enable if using external images
    }).then((canvas) => {
      const imgData = canvas.toDataURL('image/png');
      const pdf = new jsPDF('p', 'mm', 'a4'); // Create A4 size page
      const imgProps = pdf.getImageProperties(imgData);
      const pdfWidth = pdf.internal.pageSize.getWidth();
      const pdfHeight = (imgProps.height * pdfWidth) / imgProps.width;
  
      const marginTop = 20; // Define top margin in mm
            ...
            <DataTableBody compact>
              <DataTableHead>
                ...
                <DataTableRow size="md">
                  <span style={{fontWeight:"bold"}} className="sub-text">Data 1</span>
                </DataTableRow>
                <DataTableRow size="sm">
                  <span style={{fontWeight:"bold"}} className="sub-text">Data 2</span>
                </DataTableRow>
                <DataTableRow size="sm">
                  <span style={{fontWeight:"bold"}} className="sub-text">Data 3</span>
                </DataTableRow>
                <DataTableRow size="sm">
                  <span style={{fontWeight:"bold"}} className="sub-text">View</span>
                </DataTableRow>
                {/* <DataTableRow size="sm">
                  ...
                  return (
                    <DataTableItem key={item.ov_headers_id}>
                      ...
                      <span >
                       ...
                       className="submit" style={{backgroundColor:"#206296", color:"white",height:"25px", marginLeft:"-20px"}}>View</Button>
                       </span>
                      </DataTableRow>
                      <Modal isOpen={modal.show} toggle={() => setModal({ edit: false })} className="modal-dialog-centered" size="lg">
          <ModalBody>
            <a
              href="#cancel"
              onClick={(ev) => {
            ...
            <div className="p-2">
            <div style={{backgroundColor:"white", padding:"20px", width:"100%", height:'130px', display:'flex'}}>
            <div style={{padding:'10px', height:"95%",border: '1px solid black'}}>
              <img  src={universityLogoSrc}  style={{width:"90px"}}></img>
              </div>
              <div  style={{fontSize:"12px" ,margin:'0px 2px',width:"100%", height:"95%",border: '1px solid black', textAlign:"center", padding:'10px'}}>
              ...
              <img src={collegeLogoSrc} style={{width:"90px"}}></img>
                      ...
                      <DataTableRow className="nk-tb-col-tools">
                        ...
                        <Modal isOpen={deleteModal} toggle={deleteToggleModal} className="modal-dialog-centered" size="xs">
                                  <ModalBody>
                                    <a
                                      href="#cancel"
                                      onClick={(ev) => {
                                ...
                                <div className="confirmation-buttons">
                                  <button className="confirm-button" onClick={deleteHandler} >Confirm</button>
                                  <button className="cancel-button" onClick={deleteToggleModal}>Cancel</button>
                                </div>
                              </div>
                              </ModalBody>
            ...
            <div className="p-2">
              ...
              <div className="mt-4">
                <Form className="row gy-4" onSubmit={handleSubmit(AddSubmitHandler)}>
                  ...
                  <Col md="6">
                    <FormGroup>
                      ...
                      onChange={(e) => setConductionMonth(e.value)}
                      >
                  ...
                  <Dropzone accept={[".jpg", '.png']} multiple={false} onDrop={(acceptedFiles) => handleDropChange(acceptedFiles, setFiles)} maxSize={4194304}>
                          ...
                          >
                            ...
                            <div className="dz-image">
                              ...
                              <iframe src={file.preview} name="iframe_a"
                                height="600px" width="100%" title="Iframe Example">
                              </iframe>
                            </div>
                ...
                <Col Col md="6">
                  ...
                  <Dropzone accept={['.jpg', '.png']} multiple={false} onDrop={(acceptedFiles) => handleDropChange2(acceptedFiles, setFiles2)} maxSize={4194304}>
                  {({ getRootProps, getInputProps }) => (
                    <section>
                      <div {...getRootProps()} className="dropzone upload-zone dz-clickable">
                        <input {...getInputProps()} />
            ...
            <div className="p-2">
              ...
              <div className="mt-4">
                <Form className="row gy-4" onSubmit={handleSubmit(onEditSubmit)}>
                  ...
                  <FormGroup>
                  <label className="form-label">College Logo</label>
                  <Dropzone accept={['.jpg', '.png']} multiple={false} onDrop={(acceptedFiles) => handleDropChange3(acceptedFiles, setFiles2)} maxSize={4194304}>
                  {({ getRootProps, getInputProps }) => (
                    <section>
                      <div {...getRootProps()} className="dropzone upload-zone dz-clickable">
                        <input {...getInputProps()} />
                ...
                <Col Col md="6">
                  <FormGroup>
                  <label className="form-label">University Logo</label>
                  <Dropzone accept={['.jpg', '.png']} multiple={false} onDrop={(acceptedFiles) => handleDropChange4(acceptedFiles, setFiles2)} maxSize={4194304}>
                  {({ getRootProps, getInputProps }) => (
                    <section>
                      <div {...getRootProps()} className="dropzone upload-zone dz-clickable">
                        <input {...getInputProps()} />
