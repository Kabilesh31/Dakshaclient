  ...
  const downloadFile = (item) => {
    try {
      ...
      if (isBase64(item.data)) {
        ...
        binaryString = new TextDecoder().decode(item.data);
      }
        ...
        <BlockBetween>
          <BlockHeadContent>
            ...
            <div style={{ position: "absolute", right: 0 }}>
              <Button onClick={toggleAssignModal} color="primary" size="md">
                Upload
              </Button>
            </div>
            {/* <BlockDes>
      ...
      <BlockHead size="sm">
        <BlockBetween>
          <BlockHeadContent>
            ...
            <BlockDes>{/* <p>You will get only those email notification what you want.</p> */}</BlockDes>
          </BlockHeadContent>
        </BlockBetween>
      </BlockHead>
