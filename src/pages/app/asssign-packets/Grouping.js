...
const Grouping = ({currentItems, toggleState}) => {
  ...
  const getTransparencyDataBySubjectCode = async()=> {
   ...
   const filteredInvoice = groupData.filter((item, index, self) => 
                    ...
                    <tr key={groupItem._id} className="tb-tnx-item" onClick={(e) => e.stopPropagation()}>
                      ...
                      <span
                            className={`tb-status text-${
                              groupItem.isPaid === true ? "success"  : "danger"
                            }`}
                          >
             ...
             <div className="card-inner-group">
               ...
               <div  className="confirmation-container">
                 ...
                 <div className="confirmation-buttons">
                   <button className="confirm-button" onClick={handleIsPaid}>Confirm</button>
