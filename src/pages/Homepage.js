...
const Homepage = () => {
  ...
  const filteredBill = billData?.filter(
  ...
  const totalAmount = filteredAmount.reduce((acc, amt) => acc + (amt.totalAmount || 0), 0);
      ...
      <Content>
        ...
        <Block>
          <Row className="g-gs">
                    ...
                    <Col sm="6" lg="12" xxl="6">
                      <PreviewAltCard>
                        <ActiveUser
                          ...
                          currentYearCutomers={currentYearCutomers}
                          type={true}
                        />
                      </PreviewAltCard>
                    </Col>
            ...
            <Col xxl="8">
              <Card className="card-bordered card-full">{/* <TransactionTable /> */}</Card>
            </Col>
