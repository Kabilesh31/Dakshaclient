...
import FormLayouts from "../pages/components/forms/SearchLayout";
...
import ProductsListCompact from "../pages/pre-built/user-manage/ProductsListCompact";
import StockListCompact from "../pages/pre-built/user-manage/StockListCompact copy";
import SearchLayout from "../pages/components/forms/SearchLayout";
import BillingLayout from "../pages/components/forms/BillingLayout";
import BlankPage from "../pages/others/Blank";
import StockList from "../pages/pre-built/user-manage/StockList";
...
import SalaryReport from "../pages/pre-built/user-manage/SalaryReport";
  ...
  return (
    <Suspense fallback={<div />}>
      <Switch>
        ...
        <Route exact path={`${process.env.PUBLIC_URL}/search`} component={SearchLayout}></Route>
        ...
        ></Route>
         <Route //Context Api added
          exact
          path={`${process.env.PUBLIC_URL}/salary-report`}
          render={() => (
            <UserContextProvider>
              <SalaryReport />
            </UserContextProvider>
      ...
      />
        ...
        ></Route>
        <Route //Context Api added - Staff Attendance Details
          exact
          path={`${process.env.PUBLIC_URL}/staff-attendance/:id`}
          render={(props) => (
            <UserContextProvider>
              <StaffAttendanceDetails {...props} />
            </UserContextProvider>
          )}
        ></Route>
